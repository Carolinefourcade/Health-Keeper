 ...
 */
final class Version20200624145327 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE annoyance_zone (id INT AUTO_INCREMENT NOT NULL, naÃme VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE medical_record (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, annoyance_zone_id INT NOT NULL, pain_intensity_id INT NOT NULL, annoyance_id INT NOT NULL, created_at DATETIME NOT NULL, details VARCHAR(255) DEFAULT NULL, INDEX IDX_F06A283EA76ED395 (user_id), INDEX IDX_F06A283E7F3DE187 (annoyance_zone_id), INDEX IDX_F06A283E8DF2D081 (pain_intensity_id), INDEX IDX_F06A283E613E94CE (annoyance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, mail VARCHAR(100) NOT NULL, password VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
